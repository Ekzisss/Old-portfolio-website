$(document).ready(function () {
  ...
  $('.show-mobile').click(function (item) {
    if (item.target.classList.length == 1) {
      ...
      $('.mobile').animate({ width: 325 }, 1000);
    } else {
      $('.mobile').animate({ width: 0 }, 1000, function () {
        $('.mobile').hide();
      });
    }
  ...
  $('.friends-item').click(function (item) {
    ...
    $('.profile').show();
    $('.profile').animate({ width: 230, 'padding-left': 20 }, 1000);
  });
  ...
  $('.profile__exit').click(function () {
    ...
    $('.profile').animate({ width: 0, 'padding-left': 0 }, 1000, function () {
      $('.profile').hide();
    });
